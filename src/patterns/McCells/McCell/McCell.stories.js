...
export const WithSlots = () => ({
  ...
  props: {
    ...
    slotDefault: {
      default: text('slot default', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias autem culpa dignissimos et id minima quae qui sapiente ullam velit?', 'withSlots'),
    },
  },
  template: `<mc-cell :size="size">
    <mc-title slot="title" color="blue">{{title}}</mc-title>
