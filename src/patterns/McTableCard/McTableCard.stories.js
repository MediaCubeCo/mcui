...
const wrapper = () => {
    return {
        template: `
            <div style="position: relative; margin-bottom: -3rem; height: calc(100vh - 3rem); width: 100%;">
                <story />
            </div>
        `,
    }
...
export const Default = () => ({
    ...
    props: {
        ...
        footerBlur: {
            default: boolean('footerBlur', false, 'default'),
        },
        hasSlotFooter: {
    ...
    template: `
        <mc-root>
            <mc-table-card :ml="ml" :footer-blur="footerBlur">
