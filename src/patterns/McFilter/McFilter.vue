            ...
            <div v-if="isOpen" class="mc-filter__body">
                ...
                <div class="mc-filter__body-bottom">
                    <div class="mc-filter__body-bottom-left">
                        <mc-button :disabled="buttonConfirmIsDisable" size="s" @click.native="handleConfirm">
    ...
    methods: {
        ...
        onMouseMove(e) {
            ...
            if (this.dragOptions.isDrag) {
                this.$refs.dragArea.scrollTo({ left: this.dragOptions.scrollPos - this.dragOptions.distance })
            }
        ...
        editRelationValue() {
            ...
            const tagRelation = {
                [this.activeTag.category]: { [this.activeTag.relationKey]: tagRelationValue },
            }
            const selectedRelation = { [this.selectedOptionFilter]: _cloneDeep(this.currentCondition) }
                ...
                relationKeys.forEach(k => {
                    if (k === 'exists') {
                        ...
                        if (k in selectedCategory) {
                            ...
                            selectedCategoryName[k] = { ...selectedCategoryName[k], ...this.currentConditionName[k] }
                        } else {
